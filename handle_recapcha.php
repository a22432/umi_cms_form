...
if(isset($_POST['g-recaptcha-response'])) {
    ...
    if($reCaptchaValid['success'] == 1) {
		...
		if(!$mailer->Send()){
			...
			$result['result'] = "Спасибо за Ваше обращение. Ваши документы отправлены. В ближайшее время с Вами свяжется юрист для подтверждения заказа и уточнения деталей.";
        ...
        //echo 'Вы не прошли проверку капчи, попробуйте сново';
    }
